...
Haldane模型是一个基于石墨烯六角晶格的模型。 ![](/assets/physics/graphne-fig.png)
...
|  |  |
|----|----|
| ![](/assets/physics/haldane-no-t2.jpg)图1 没有t2项的能带图 | ![](/assets/physics/haldane-with-t2.jpg)图2 有t2项的能带图 |
...
在mathematica中使用本征值求解函数， ![](/assets/physics/haldane3d.jpg)

我们也可以得到在不同位置的二维能带图

![](/assets/physics/haldane2d.jpg)
